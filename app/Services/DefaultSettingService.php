...
class DefaultSettingService {
    ...
    public static function get() {
        ...
        return [
            ...
            ['name' => 'apple_authentication', 'value' => '0', 'type' => 'boolean'],
            ['name' => 'realtime_events_enabled', 'value' => '1', 'type' => 'boolean'],
            ['name' => 'push_notifications_enabled', 'value' => '1', 'type' => 'boolean'],
            ['name' => 'live_tracking_enabled', 'value' => '1', 'type' => 'boolean'],
            ['name' => 'engagement_tracking_enabled', 'value' => '1', 'type' => 'boolean'],
            ['name' => 'frontend_observability_enabled', 'value' => '1', 'type' => 'boolean'],
