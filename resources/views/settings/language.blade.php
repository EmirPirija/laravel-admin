                            ...
                            <div class="col-12">
                                <table class="table-light table-striped" aria-describedby="mydesc" id="table_list"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" data-field="country_code" data-sortable="true">{{ __('Country Code') }}</th>
                            ...
                            <div class="col-sm-12">
                                <div class="col-md-12 col-12">
                                    <div class="form-group mandatory">
                                        ...
                                        <input type="text" id="edit_country_code" class="form-control col-12" placeholder="{{__("Country Code")}}" name="country_code" data-parsley-required="true">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="edit_panel_file" class="form-control col-12" name="panel_file" accept=".json">
                                        <a id="download_panel_file" href="#" target="_blank" class="btn btn-sm btn-outline-primary mt-2">
                            ...
                            <div class="col-sm-12">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="edit_app_file" class="form-control col-12" name="app_file" accept=".json">
                                        <a id="download_app_file" href="#" target="_blank" class="btn btn-sm btn-outline-primary mt-2">
                                            <i class="bi bi-download"></i> {{ __('Download Current') }}
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="edit_web_file" class="form-control col-12" name="web_file" accept=".json">
                                        <a id="download_web_file" href="#" target="_blank" class="btn btn-sm btn-outline-primary mt-2">
                                            <i class="bi bi-download"></i> {{ __('Download Current') }}
                                        </a>
                                    </div>
                                </div>
