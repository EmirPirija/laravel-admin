...
@section('title')
    {{ __('Advertisement Listing Packages') }}
@endsection
...
@section('content')
    <section class="section">
        <div class="row">
            ...
            @endcan
            <div class="{{\Illuminate\Support\Facades\Auth::user()->can('advertisement-listing-package-create') ? "col-md-8" : "col-md-12"}}">
                <div class="card">
                    <div class="card-body">
                                        ...
                                        <div class="tab-pane fade @if($key == 0) show active @endif" id="edit-lang-{{ $lang->id }}" role="tabpanel">
                                            ...
                                            @if($lang->id == 1)
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        {{ Form::label('limit', __('Advertisement Limit'), ['class' => 'form-label col-12 col-sm-12  col-md-6 ']) }}
                                                        <div class="row">
                                                            <div class="col-md-3">
