...
@section('content')
    <section class="section">
        <div class="row">
            @can('featured-advertisement-package-create')
                <div class="col-md-4">
                    <div class="card">
                                ...
                                @foreach($languages as $key => $lang)
                                    <div class="tab-pane fade @if($key == 0) show active @endif" id="lang-{{ $lang->id }}" role="tabpanel">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description[{{ $lang->id }}]" class="form-control" rows="3" cols="48" @if($lang->id == 1) data-parsley-required="true" @endif></textarea>
                                        </div>
                                        ...
                                        @if($lang->id == 1)
                                            ...
                                            <div id="limit" class="col-md-12 col-sm-12 form-group">
                                                <div class="row">
                                                    {{ Form::label('limit', __('Advertisement Limit'), ['class' => 'form-label col-12 ']) }}
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text myDivClass" style="height: 42px;">
            ...
            @endcan
            <div class="{{\Illuminate\Support\Facades\Auth::user()->can('featured-advertisement-package-create') ? "col-md-8" : "col-md-12"}}">
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <table class="table table-borderless table-striped" aria-describedby="mydesc"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" data-field="item_limit" data-align="center" data-sortable="true">{{ __('Advertisement Limit') }}</th>
                                        <th scope="col" data-field="ios_product_id" data-align="center" data-sortable="true" data-visible="false">{{ __('IOS Product ID') }}</th>
                                        @can('advertisement-listing-package-update')
